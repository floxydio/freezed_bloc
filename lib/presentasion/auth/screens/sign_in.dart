...
import 'package:freezed_auth/presentasion/auth/screens/sign_up.dart';
...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body:
        BlocBuilder<HydratedAuthsaveCubit, HydratedAuthsaveState>(
          ...
          child: BlocListener<AuthCubit, AuthState>(
            listener: (context, state) {
              if (state.isSuccess == 'success') {
                context.read<HydratedAuthsaveCubit>().updateEmail(state.email);
                  ...
                  Row(
                    children: [
                      Checkbox(
                        ...
                        onChanged: (v) {
                          context
                              .read<HydratedAuthsaveCubit>()
                              .updateIsSave(v!);

                          if (v == false) {
                            context.read<HydratedAuthsaveCubit>().reset();
                          }
                        },
                      ),
                      Text('Remember Email',
                          style:
                              FontPoppins.font14.copyWith(color: Colors.grey))
                    ],
                  ),
                  Align(
